...
<head>
    ...
    <title>Form Master Jurusan | SMK Ma'arif Wonosari</title>
...
<body class="hold-transition sidebar-mini px-4 py-4">
    ...
    @endif
    <form action="{{ url('mjurusan/') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card card-success">
            <div class="card-header">
                <h3 class="card-title">Form Master Input Jurusan</h3>
            </div>
            <div class="card-body">
