...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Agu 2023 pada 02.33
...
(12, '2023_08_23_142246_create_model_form_pendaftarans_table', 6);
...
CREATE TABLE `model_form_pendaftarans` (
  ...
  `idjurusan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data untuk tabel `model_form_pendaftarans`
--

INSERT INTO `model_form_pendaftarans` (`id`, `nopendaftaran`, `nmlengkap`, `nik`, `nisn`, `alamat`, `notelp_siswa`, `tmplahir`, `tgllahir`, `jnskelamin`, `agama`, `asal_sekolah`, `alamat_sekolah`, `nmortu`, `alamat_ortu`, `pekerjaan_ortu`, `notlp_ortu`, `nilai_bindo`, `nilai_binggris`, `nilai_mtk`, `nilai_ipa`, `doc_nilaiujian`, `idjurusan`, `doc_ketlulus`, `doc_foto`, `doc_lainnya`, `created_at`, `updated_at`) VALUES
(1, '0', 'saya', '1234567890123456', '112233', 'Bansari Kepek wonosari', '083842161224', 'gunungkidul', '2007-12-12', 'laki-laki', 'islam', 'smp 4 wno', 'Bansari Kepek wonosari', 'roni', 'Bansari Kepek wonosari', 'pns', '083842161224', 70, 75, 80, 80, 'public/O59iNWhaTAg9PWZYu95blYDEDIaZNThzKojsJoJw.pdf', '1', 'public/136jOtBGAxNQCwztO5de5ll0CFrBJtX7soKBarFh.jpg', 'public/efjgMY0lIJtU5nkOaD92KLx5hRVM4glZZeNXgmlk.png', 'public/wKqO7nlKUbFR1ZUsfLDE9YseNXlYZDunROrGgpQx.png', '2023-08-24 07:48:09', '2023-08-24 07:48:09'),
(2, 'PPDB23-01', 'Jojon', '1122334455667788', '224455', 'Bansari Kepek wonosari', '083842161224', 'gunungkidul', '2005-11-13', 'laki-laki', 'islam', 'smp 4 wno', 'Bansari Kepek wonosari', 'Baba', 'Bansari Kepek wonosari', 'buru', '083842161224', 12, 12, 12, 12, 'public/hBzZtpFSO7G202iWXhucIuZ0SbOBbHKvTVfRAEhr.jpg', '3', 'public/uBH9vidW4vdlnYwVZEtFvGT1uDKaLVG74uFvUpKv.jpg', 'public/d0koeCnZGPlaAtvyNLdKnbZvQvXzO0CXc1ukb77H.jpg', 'public/lB9VFRkwJ6xpuB1HKboMSNrbaA52esEHdT8jdNcy.pdf', '2023-08-24 08:11:39', '2023-08-24 08:11:39'),
(3, 'PPDB23-02', 'sd', '1919191919191919', '112233', 'Bansari Kepek wonosari', '083842161224', 'Gunungkidul', '2005-04-12', 'laki-laki', 'Islam', 'SMP 1 Tepus', 'Tepus', 'Parjo', 'Tepus', 'Buruh Tani', '083842161224', 55, 78, 90, 78, 'public/IZMxKTK0M7YhPz5t9GXDwi5BKskC369xPfmWdT1O.jpg', '2', 'public/K5VNNh3vzhSwJZhxNYRdm8xta5JrzvNnTdmR6rNd.png', 'public/Y8HoI8fbyXBBSeTnS50C8vL47tQZrvGNluIDwKbO.pdf', 'public/RCLzfwZnH3g7smvR3hlPfSDLeId8sLTqW87nEvJJ.pdf', '2023-08-24 17:02:08', '2023-08-24 17:02:08');
